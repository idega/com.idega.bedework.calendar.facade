...
public abstract class BwPrincipal extends BwDbentity<BwPrincipal>
  ...
  /** Create a BwPrincipal usually based on a single string name from an object,
   * e.g., an event.
   *
   * @param  account            String user id for database
   */
  public BwPrincipal(final String account) {
   ...
   * @param val   BwPrincipal
   */
  public static void toStringSegment(final StringBuilder sb, final String name, final BwPrincipal val) {
    if (name != null) {
      sb.append(", ");
      sb.append(name);
      sb.append("=");
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BwPrincipal{");
