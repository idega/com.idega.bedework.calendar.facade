...
public class BwPreferences extends BwOwnedDbentity implements PropertiesEntity {
  ...
  public void setAttachmentsPath(final String val) {
    BwProperty prop = findProperty(propertyAttachmentsFolder);

    if (prop == null) {
      prop = new BwProperty();
      prop.setName(propertyAttachmentsFolder);
      prop.setValue(val);
  ...
  public void setDefaultTzid(final String val) {
    BwProperty prop = findProperty(propertyDefaultTzid);

    if (prop == null) {
      prop = new BwProperty();
      prop.setName(propertyDefaultTzid);
      prop.setValue(val);
  ...
  public void setQuotaUsed(final long val) {
    BwProperty prop = findProperty(propertyQuotaUsed);

    if (prop == null) {
      prop = new BwProperty();
      prop.setName(propertyQuotaUsed);
